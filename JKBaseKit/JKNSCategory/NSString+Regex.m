...
-(BOOL)validatePhoneNumber
{
     ...
     * 联通：130,131,132,152,155,156,185,186,145,176,175,
     * 电信：133,1349,153,180,181,189,177,173
     */
    NSString *isMobileRegex = @"^(((13[0-9]{1})|(14[57]{1})|(15[0-9]{1})|(17[0-9]{1})|(18[0-9]{1}))+\\d{8})$";
